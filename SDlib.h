...
enum{MMC_SUCCESS=0,MMC_TIMEOUT_ERROR=-1,MMC_DMA_TX_TIMEOUT_ERROR=-3,MMC_BUSY_TIMEOUT_ERROR=-4,
     ...
     MMC_INIT_ERR_READ_OCR=-13,MMC_INIT_ERR_BLOCK_SIZE=-14,MMC_DMA_RX_TIMEOUT_ERROR=-15,
     MMC_TOKEN_TIMEOUT_ERROR=-16,MMC_IDLE_TIMEOUT_ERROR=-17,MMC_INTERNAL_ERROR=-18,MMC_LAST_ERR=-19};
